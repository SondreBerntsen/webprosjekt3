...
CREATE TABLE `events` (
  ...
  `livestream` enum('true','false') COLLATE utf8_bin DEFAULT 'false',
  `u_id` int(11) DEFAULT NULL,
  `v_id` int(11) DEFAULT NULL,
  `img_path` varchar(50) COLLATE utf8_bin DEFAULT 'eventImg/img',
  `thumbnail_path` varchar(50) COLLATE utf8_bin DEFAULT 'eventImg/thumbnail'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `images` (
  ...
  `img_path` varchar(50) COLLATE utf8_bin DEFAULT 'sliderImg'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
INSERT INTO `images` (`id`, `title`, `caption`, `r_id`, `img_path`) VALUES
(1, 'Lorem ipsum dolor', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut', 1, 'sliderImg'),
(2, 'Lorem ipsum ', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore', 1, 'sliderImg'),
(3, 'Lorem ipsum dolor ', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore', 1, 'sliderImg'),
(4, 'Lorem ', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore', 2, 'sliderImg'),
(5, 'Lorem ip', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore', 2, 'sliderImg'),
(6, 'Lorem i', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore', 2, 'sliderImg');
...
CREATE TABLE `posts` (
  ...
  `date` date DEFAULT NULL,
  `u_id` int(11) DEFAULT NULL,
  `img_path` varchar(50) COLLATE utf8_bin DEFAULT 'postImg/img',
  `thumbnail_path` varchar(50) COLLATE utf8_bin DEFAULT 'postImg/thumbnail'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
