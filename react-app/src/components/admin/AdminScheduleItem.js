...
const AdminScheduleItem = props => {
  ...
  */
  let {
    event: { id, title, venue, time, price, date }
  } = props;
        ...
        <div className="elementCardAdmin row">
          ...
          <div className="col-md-2">
            <button
              ...
              data-target={"#scheduleItemForm" + id}
              aria-expanded="false"
              aria-controls={"scheduleItemForm" + id}
            >
              Edit
            </button>
          </div>
      ...
      <div className="collapse editScheduleItem" id={"scheduleItemForm" + id}>
        <form className="col-md-8 col-lg-6">
          ...
          <div className="form-row">
            <div className="form-group col-md-6">
              <label>Time</label>
              <input type="time" className="form-control" defaultValue={time} />
            </div>
            <div className="form-group col-md-6">
              <label>Date</label>
