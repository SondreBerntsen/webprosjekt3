    ...
    events: [
      {
        ...
        thumbnail: "https://www.drammensacred.no/wp-content/uploads/2018/07/Vinterma%CC%8Ane-960x654.jpg",
          ...
          <div className="collapseForm col-12 collapse" id="newEventForm">
            <form className="col-md-8 col-lg-6">
              ...
              <div className="form-check form-check-inline">
                ...
                <label className="form-check-label" for="inlineRadio1">Planned Livestream</label>
              </div>
              <div class="form-check form-check-inline">
                <input className="form-check-input" checked type="radio" name="inlineRadioOptions" id="inlineRadio2" value="option2" />
                <label className="form-check-label" for="inlineRadio2">No livestream</label>
              </div>
